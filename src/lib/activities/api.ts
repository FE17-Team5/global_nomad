...
// 체험 목록 조회
export async function getActivitiesList(query: ActivitiesListQuery): Promise<ActivitiesListResponse> {
...
export async function getAvailableSchedule(
  ...
  return apiFetch<AvailableScheduleResponse>(`/${TEAM_ID}/activities/${activityId}/available-schedule`, {
    query,
  });
}
...
export async function getActivityReviews(
  ...
  return apiFetch<ActivityReviewsResponse>(`/${TEAM_ID}/activities/${activityId}/reviews`, {
    query,
  });
}
...
export async function createReservation(
  ...
  return apiFetch<CreateReservationResponse>(`/${TEAM_ID}/activities/${activityId}/reservations`, {
    method: "POST",
    body,
    authToken,
  });
