...
const ReservationSidebar = ({ price, availableSchedules }: ReservationSidebarProps) => {
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          >
            ...
            <button
              ...
              style={{
                cursor: !selectedDate || headCount <= 1 ? 'not-allowed' : 'pointer',
            ...
            >
              <img 
                ...
                className="w-6 h-6"
                style={{
                  filter: !selectedDate || headCount <= 1 
            ...
            {/* 숫자 */}
            <div className="max-w-10 max-h-10 w-10 h-10 flex items-center justify-center ty-16_B" style={{ color: "var(--color-gray-1)" }}>
              {headCount}
            </div>
            ...
            <button
              ...
              className="max-w-10 max-h-10 w-10 h-10 flex items-center justify-center"
              style={{
                cursor: !selectedDate || headCount >= MAX_HEAD_COUNT ? 'not-allowed' : 'pointer',
            ...
            >
              <img 
                ...
                className="w-6 h-6"
                style={{
                  filter: !selectedDate || headCount >= MAX_HEAD_COUNT
                    ? 'brightness(0) saturate(100%) invert(80%) sepia(0%) saturate(0%)'
                    : 'none'
                }}
              />
            ...
            {availableTimes.length > 0 ? (
              availableTimes.map((schedule) => (
                <button
                  ...
                  style={{
                    border: selectedTimeId === schedule.id 
                      ? "2px solid #3D9EF2"
                      : "1px solid var(--color-gray-300)",
                    backgroundColor: selectedTimeId === schedule.id 
                      ? "#E5F3FF"
                      : "transparent",
                    color: selectedTimeId === schedule.id 
                      ? "#3D9EF2"
                      : "var(--color-gray-950)",
              ...
              <p className="ty-14_M text-center py-4" style={{ color: "var(--color-gray-200)" }}>
                날짜를 먼저 선택해주세요
              </p>
            )}
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="ty-20_B" style={{ color: "var(--color-gray-950)" }}>
          ...
          <button
            ...
            style={{
              backgroundColor: !selectedDate || !selectedTimeId ? "var(--color-gray-300)" : "#3D9EF2",
              color: "#FFFFFF",
              cursor: !selectedDate || !selectedTimeId ? "not-allowed" : "pointer",
            }}
            aria-label="예약하기"
          >
            예약하기
