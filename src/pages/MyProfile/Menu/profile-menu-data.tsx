...
import ReservationList from "../../../components/ReservationList/reservation-list";
...
export const profileMenuDataList: ProfileMenuDataListType[] = [
  {
    id: 0,
    Icon: PersonIcon,
    title: "내 정보",
    content: "닉네임과 비밀번호를 수정하실 수 있습니다.",
  },
  {
    id: 1,
    Icon: ReservationIcon,
    title: "예약내역",
    content: "예약내역 변경 및 취소할 수 있습니다.",
  },
  {
    id: 2,
    Icon: SettingIcon,
    title: "내 체험 관리",
    content: "체험을 등록하거나 수정 및 삭제가 가능합니다.",
  },
  {
    id: 3,
    Icon: CalendarIcon,
    title: "예약 현황",
    content: "내 체험에 예약된 내역들을 한 눈에 확인할 수 있습니다.",
  },
];
...
function ReservationIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg
      width="24"
      height="24"
...
function SettingIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg
      width="24"
      height="24"
